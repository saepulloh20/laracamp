                            ...
                            <form action="{{ route('checkout.store', $camp->id) }}" method="POST" class="basic-form">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="occupation" type="text"
                                        ...
                                        id="occupation" aria-describedby="emailHelp"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="card_number" type="number"
                                        ...
                                        id="card_number" aria-describedby="emailHelp"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="expired" type="month"
                                                ...
                                                id="exampleInputEmail1" aria-describedby="expired"
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="number"
                                                ...
                                                id="exampleInputEmail1" aria-describedby="cvc" maxlength="3"
